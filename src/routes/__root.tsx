...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Al Diplomacy Insurance Services LLC" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/ZB4VEHbTzTSvXvVaalw05WZckEj2/social-images/social-1781797998973-ChatGPT_Image_Jun_18,_2026,_06_53_13_PM.webp" },
      { property: "og:image:alt", content: "Al Diplomacy Insurance Services LLC" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/ZB4VEHbTzTSvXvVaalw05WZckEj2/social-images/social-1781797998973-ChatGPT_Image_Jun_18,_2026,_06_53_13_PM.webp" },
