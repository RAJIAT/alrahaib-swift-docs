...
export const translations = {
  ar: {
    ...
    upload: {
      ...
      emiratesHint: "ارفع صورة الوجه وصورة الظهر للهوية",
      registrationHint: "ارفع صورة الوجه وصورة الظهر للملكية",
      licenseHint: "ارفع صورة الوجه وصورة الظهر للرخصة",
      optional: "اختياري",
      required: "إلزامي",
      addPhoto: "إضافة صورة",
  ...
  en: {
    ...
    upload: {
      ...
      emiratesHint: "Upload the front and back images of the ID",
      registrationHint: "Upload the front and back images of the registration",
      licenseHint: "Upload the front and back images of the license",
      optional: "Optional",
      required: "Required",
      addPhoto: "Add photo",
