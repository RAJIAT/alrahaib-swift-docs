...
function seedAgents(): DemoAgent[] {
  return [
    ...
    { userId: "u-sls-1", id: "SLS-001", name: "Ali Sales", email: "sales@demo.com", branch: "Dubai", active: true, role: "agent", staffType: "sales", supervisorId: "u-sup-1", assignedUnderwriterId: "UW-001", createdByUserId: "u-admin", createdByRole: "admin" },
    { userId: "u-sls-2", id: "SLS-002", name: "Noor Sales", email: "sls2@demo.com", branch: "Dubai", active: true, role: "agent", staffType: "sales", supervisorId: "u-sup-1", assignedUnderwriterId: "UW-002", createdByUserId: "u-sup-1", createdByRole: "supervisor" },
    // Abu Dhabi
    ...
    { userId: "u-sls-3", id: "SLS-003", name: "Yara Sales", email: "sls3@demo.com", branch: "Abu Dhabi", active: true, role: "agent", staffType: "sales", supervisorId: "u-sup-2", assignedUnderwriterId: "UW-003", createdByUserId: "u-sup-2", createdByRole: "supervisor" },
    // Sharjah
